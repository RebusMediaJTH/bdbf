      ...
      return firstPagePromise.then(function (pdfPage) {
       ...
       for (var pageNum = 1; pageNum <= pagesCount; ++pageNum) {
        ...
        var pageView = new PDFPageView({
         ...
         annotationLayerFactory: 'disabled' === window.top.rebus.config.mozillaPDFViewerLinks ? null : this,
         enhanceTextSelection: this.enhanceTextSelection,
         renderInteractiveForms: this.renderInteractiveForms,
   ...
   var PDFViewerApplication = {
    ...
    initialize: function pdfViewInitialize(appConfig) {
     ...
     return this._readPreferences().then(function () {
      ...
      if ('open-new-window' === window.top.rebus.config.mozillaPDFViewerLinks) {
          PDFJS.externalLinkTarget = PDFJS.LinkTarget.BLANK;
      }
      else if (self.isViewerEmbedded && !PDFJS.isExternalLinkTargetSet()) {
